...
app.use(cors({ origin: process.env.FRONTEND_URL || 'https://adc-mu.vercel.app/', credentials: true, methods: ['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'OPTIONS'], allowedHeaders: ['Content-Type', 'Authorization', 'X-CSRF-Token'] }));
app.use(compression());
