...
router.post('/courses/:id/draft', instructorController.saveDraft);   // ✅ NEW DRAFT ROUTE
...
router.post('/courses/:courseId/thumbnail', upload.single('image'), instructorController.uploadCourseThumbnail);
router.post('/courses/:courseId/lessons/:lessonId/image', upload.single('image'), instructorController.uploadLessonImage);
