...
export class AnnouncementService {
  ...
  async createAnnouncement(title: string, content: string, createdBy: string, type: string = 'info') {
    const announcement = new Announcement({ title, content, type, createdBy, isActive: true });
