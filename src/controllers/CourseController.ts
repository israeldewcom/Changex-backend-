// ============================================
// FILE: src/controllers/CourseController.ts (Complete with affiliate conversion)
// ============================================
    ...
    try {
      ...
      if (paymentMethod === 'wallet') {
        ...
        if (affId && affCourseId === courseId && affCode) {
          await this.affiliateService.completeAffiliateConversion(userId, courseId, price, transaction._id);
        }
