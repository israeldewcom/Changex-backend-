// ============================================================
// FILE: src/controllers/admin.controller.ts (FULLY UPDATED)
// ============================================================
...
export const uploadImage = async (req: Request, res: Response) => {
  try {
    // Multer with `any()` will put files in `req.files` array
    ...
    const file = files[0];
    const result = await uploadToCloudinary(file.buffer, 'admin/uploads');
